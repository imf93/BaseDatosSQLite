...
public class DB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table datos(nombre text, apellido text,apellido2 text, apellido3 text)");
    }
    ...
    public String guardar(String nombre, String apellido, String apellido2, String apellido3){
        String mensaje="";
